...
@NgModule({
    ...
    imports: [BrowserModule, FormsModule, AppRouter],  //引用其他angular modules
    declarations: [AppComponent, HeroFormComponent, HeroInfoComponent, DashboardComponent],   //声明components和directives和pipes
